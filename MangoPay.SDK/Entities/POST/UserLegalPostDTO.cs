...
namespace MangoPay.SDK.Entities.POST
{
    ...
    {
        public UserLegalPostDTO(string email, string name, string companyNumber, LegalPersonType legalPersonType, string legalRepresentativeFirstName, string legalRepresentativeLastName, DateTime? legalRepresentativeBirthday, CountryIso legalRepresentativeNationality, CountryIso legalRepresentativeCountryOfResidence)
        {
            Email = email;
            Name = name;
